...
focused on creating databases and table operations. This test will actually consist of a more open-ended assignment below:
*/
--Criamos o database School utilizando botão direito e Create em databases.
